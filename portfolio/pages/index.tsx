    ...
    <div>
      ...
      <div className="flex mx-auto max-w-xl pt-16 relative">
        <div className="flex items-center absolute opacity-40 top-0 pt-16">
          ...
          <div className="relative md:top-0 top-[40px] left-[-50px] w-80 h-80 rounded-full bg-gradient-to-b from-green-400 to-blue-500 z-30 animate-spin-slow"></div>
          <div className="self-end relative top-0 left-[-100px] md:w-60 md:h-60 rounded-full bg-gradient-to-b from-pink-500 to-yellow-500 z-20 animate-spin-slow"></div>
        </div>
